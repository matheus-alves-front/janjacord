...
contextBridge.exposeInMainWorld("janjacord", {
  ...
  serverCreate: (name) => ipcRenderer.invoke("server.create", { name }),
  serverJoin,
  communityList: () => ipcRenderer.invoke("community.list"),
  communityActivate: (serverId) => ipcRenderer.invoke("community.activate", { serverId }),
